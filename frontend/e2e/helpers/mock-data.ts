...
export const MOCK_SUPPLIERS = [
  { id: 1, code: 'SUP10001', name: '华兴电子科技有限公司', category: '电子元件', level: 'A', status: 4, contact: '张三', phone: '13800001111', admissionStage: '已准入', performanceScore: 92, riskLevel: 'low', address: '深圳市南山区科技园', creditCode: '91440300MA5EXAMPLE1', blacklisted: false },
  { id: 2, code: 'SUP10002', name: '鼎盛精密制造有限公司', category: '机械加工', level: 'B', status: 4, contact: '李四', phone: '13800002222', admissionStage: '已准入', performanceScore: 85, riskLevel: 'medium', address: '苏州市工业园区', creditCode: '91320500MA5EXAMPLE2', blacklisted: false },
  { id: 3, code: 'SUP10003', name: '鑫达新材料股份有限公司', category: '化工原料', level: 'A', status: 4, contact: '王五', phone: '13800003333', admissionStage: '已准入', performanceScore: 78, riskLevel: 'low', address: '上海市浦东新区', creditCode: '91310115MA5EXAMPLE3', blacklisted: false },
  { id: 4, code: 'SUP10004', name: '恒信物流有限公司', category: '物流服务', level: 'C', status: 0, contact: '赵六', phone: '13800004444', admissionStage: '已注册', performanceScore: 60, riskLevel: 'high', address: '广州市天河区', creditCode: '91440106MA5EXAMPLE4', blacklisted: false },
  { id: 5, code: 'SUP10005', name: '鸿远光电科技有限公司', category: '光学器件', level: 'A', status: 5, contact: '孙七', phone: '13800005555', admissionStage: '已驳回', performanceScore: 45, riskLevel: 'high', address: '武汉市东湖高新区', creditCode: '91420100MA5EXAMPLE5', blacklisted: true, blacklistReason: '质量严重不达标', blacklistStartTime: '2025-01-15T00:00:00', blacklistEndTime: '' },
  { id: 6, code: 'SUP10006', name: '汇通包装材料有限公司', category: '包装材料', level: 'B', status: 4, contact: '周八', phone: '13800006666', admissionStage: '已准入', performanceScore: 88, riskLevel: 'low', address: '杭州市余杭区', creditCode: '91330110MA5EXAMPLE6', blacklisted: false },
  { id: 7, code: 'SUP10007', name: '瑞安半导体有限公司', category: '半导体', level: 'A', status: 6, contact: '吴九', phone: '13800007777', admissionStage: '已停用', performanceScore: 30, riskLevel: 'high', address: '成都市高新区', creditCode: '91510100MA5EXAMPLE7', blacklisted: true, blacklistReason: '多次交期延误', blacklistStartTime: '2025-03-01T00:00:00', blacklistEndTime: '2025-12-31T23:59:59' },
  { id: 8, code: 'SUP10008', name: '嘉和五金制品有限公司', category: '五金配件', level: 'B', status: 4, contact: '郑十', phone: '13800008888', admissionStage: '已准入', performanceScore: 82, riskLevel: 'medium', address: '东莞市松山湖', creditCode: '91441900MA5EXAMPLE8', blacklisted: false },
]
