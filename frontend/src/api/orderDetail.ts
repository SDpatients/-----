...
export const orderDetailApi = {
  ...
  create: (data: PurchaseOrderDetailCreateDTO) => request.post<number, number>('/v1/purchase-order-details', data),
  update: (id: number | string, data: PurchaseOrderDetailUpdateDTO) => request.put<void, void>(`/v1/purchase-order-details/${id}`, data),
